...
## Notes
- You decide if you want to use input elements inside label elements ( field element as descendant of label element) or adjacent to label elements (field element as sibling or cousin element of label element) 
    - this is talking about the element relationships, not visual appearance
